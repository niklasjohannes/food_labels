...
```{r save_plots, eval=F}
# study1 sensory
ggsave(here("plots", "figure1.tiff"),
       plot = sensory_plot,
       dpi = 600)
...
# study1 by food type
tiff(here("plots", "figure2.tiff"), width = 879*8, height = 632*5, units = "px", res = 600)
food_type_plot
dev.off()

# study 2 raincloud
tiff(here("plots", "figure3.tiff"), width = 879*8, height = 632*8, units = "px", res = 600)
rc_plot_study2
dev.off()

# study 2 interaction h4
ggsave(here("plots", "figure4.tiff"),
       plot = h4_plot,
       dpi = 600)
