...
Next, I load the final data files.
I saved those at the end of the analysis report (`analysis_report.Rmd`).
```{r get_data}
dat <- read_csv(here("data", "analysis_file.csv"))
attractiveness <- read_csv(here("data", "attractiveness.csv"))
simulations <- read_csv(here("data", "simulations.csv"))
...
```{r save_plots, eval=F}
# raincloud
tiff(here("plots", "raincloud.tiff"), width = 1732, height = 1266, units = "px", res = 300)
rc_plot
dev.off()

# first interaction plot: H4
tiff(here("plots", "h4_plot.tiff"), width = 1732, height = 1266, units = "px", res = 300)
h4_plot
dev.off()

# exploratory plot 1
tiff(here("plots", "frequency_meat_food_types.tiff"), width = 1732, height = 1266, units = "px", res = 300)
exp_meat_plot
dev.off()

# exploratory plot 2
tiff(here("plots", "frequency_meat_food_labels.tiff"), width = 1732, height = 1266, units = "px", res = 300)
exp_meat_label_plot
dev.off()
```
