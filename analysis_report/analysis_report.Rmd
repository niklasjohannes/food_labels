...
Under this condition, the model remained significant.
...
The results don't change for attractiveness, but forfor simulations the main effect of the intention to reduce eating meat is not significant anymore.
```{r h4_high_rsi}
# get p-value for attractiveness
h4_attr_p_rsi <-
  mixed(
